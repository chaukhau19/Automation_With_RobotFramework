...
*** Variables ***
############ General variables ##############
${Trusted/NotTrusted_tab}                  xpath=//*[@class='collapsible-header first-menu' and contains(text(),'Trusted')]
...
Go to Trusted/Not Trusted section in SCSCF tab
    Click Element        ${Trusted/NotTrusted_tab}
    Sleep   3s
