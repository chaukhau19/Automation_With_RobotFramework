...
############################## SCSCF #################
${SCSCF_section}                      xpath=//*[@class='collapsible-header active' and contains(text(),'Ibcf')]/following::div//a[@class='collapsible-header first-menu' and contains(text(),'Scscf')]

*** Keywords ***
Go to SCSCF section in IBCF tab
