...
${Name_Field}                id=name
# ${IP_DropDown_IBCF}				 xpath=//input[@value='${eth0}']
# ${IP_DropDown_IBCF}				 xpath=//input[@value='${ifcfg-lo}']
# ${IP_DropDown_IBCF}          xpath=(//div[text()[normalize-space() = 'IP:']]//following::input[@class='select-dropdown'])[1]
...
${IP_Home_TPIP_3}			xpath=//label[@for='network']//preceding::div[1]//span[contains(.,'Auto_TPIP3')]
${IP_Home_TPIP_5}			xpath=//label[@for='network']//preceding::div[1]//span[contains(.,'Auto_TPIP5')]
...
#    Run Keyword If  '${Type}' == 'home'     Click Element       ${IP_DropDown_IBCF}
   # Sleep       1s  

    Run Keyword If    '${TPIP_IP_DROPDOWN}' == '${eth0}' and '${Type}' == 'home'      Click Element        ${TPIP_IP_DropDown_eth0} 
    ...    ELSE IF    '${TPIP_IP_DROPDOWN}' == '${ifcfg-lo}' and '${Type}' == 'home'      Click Element        ${TPIP_IP_DropDown_127}
    Sleep       1s   
    ...
    Run Keyword If      '${Type}' =='visited' and '${Home_TPIP}' =='5'    Click Element       ${IP_Home_TPIP_5}
    Sleep       2s
...
View TPIP
    ...
    Run Keyword N Times And Stop If Success   Click View Element With 2 Info   ${arg}    Click Element  ${Page_2}   3
    Sleep       2s
