...
${Optional_parameters_button}         xpath=(//label[contains(text(),'Optional parameters')]/preceding::button)[last()]
...
${Autho_index_3}                    xpath=//label[contains(text(),'Authorization profile')]/preceding::div[1]/ul/li[2]/span
${Autho_index_5}                    xpath=//label[contains(text(),'Authorization profile')]/preceding::div[1]/ul/li[3]/span
${Autho_index_6}                    xpath=//label[contains(text(),'Authorization profile')]/preceding::div[1]/ul/li[4]/span
...
#${SDP_profile_none}                xpath=//select[@id='sdp_profile']/option[@value='NONE']
...
#${RFC4028_0}				        xpath=//label[contains(text(),'RFC4028 Profile')]/preceding::div[1]/ul/li[2]
#${RFC4028_1}				        xpath=//label[contains(text(),'RFC4028 Profile')]/preceding::div[1]/ul/li[3]
#${RFC4028_18}				        xpath=//label[contains(text(),'RFC4028 Profile')]/preceding::div[1]/ul/li[4]
${RFC4028_None}                     xpath=//label[contains(text(),'RFC4028 Profile')]//preceding-sibling::div[@class='select-wrapper']/ul/li[contains(.,'NONE')]
${RFC4028_1}                        xpath=//label[contains(text(),'RFC4028 Profile')]//preceding-sibling::div[@class='select-wrapper']/ul/li[contains(.,'1')]
${RFC4028_2}                        xpath=//label[contains(text(),'RFC4028 Profile')]//preceding-sibling::div[@class='select-wrapper']/ul/li[contains(.,'2')]
${RFC4028_18}                       xpath=//label[contains(text(),'RFC4028 Profile')]//preceding-sibling::div[@class='select-wrapper']/ul/li[contains(.,'18')]
...
${Lac_Stripping_True}               xpath=//button[contains(text(),'True') and contains(@onclick,'lac_stripping')]
${Lac_Stripping_False}              xpath=//button[contains(text(),'False') and contains(@onclick,'lac_stripping')]
...
${CdrPaniSource_dropdown}          xpath=//label[@for='cdrpanisource']/preceding::div[1]/input
${CdrPaniSource_FFT}               xpath=//label[@for='cdrpanisource']/preceding::div[1]//span[contains(text(),'FFT')]
${CdrPaniSource_LBO}               xpath=//label[@for='cdrpanisource']/preceding::div[1]//span[contains(text(),'LBO')]
${CdrPaniSource_NONE}              xpath=//label[@for='cdrpanisource']/preceding::div[1]//span[contains(text(),'NONE')]
...
View Header Authorization Profiles
    ...
    IF  '${Matching_rule}' != '#BLANK'                                          Verify Page Contains 2 Expected Elements    Matching rules                     ${Matching_rule}
    IF  '${Reason_protocol}' != '#BLANK' and '${Reason_protocol}' !='None'      Verify Page Contains 2 Expected Elements    Reason protocol                    ${Reason_protocol}
    IF  '${Reason_cause}' != '#BLANK'                                           Verify Page Contains 2 Expected Elements    Reason cause                       ${Reason_cause}
    IF  '${Reason_text}' != '#BLANK'                                            Verify Page Contains 2 Expected Elements    Reason text                        ${Reason_text}
...
Add Authorization Profiles
    ...
    ...     ELSE IF     '${Default_authorization}' == 'reject'        Run Keywords      Click Element       ${Default_Reject_Field}   
    ...    AND   Input Text    xpath=//input[@id='default']    ${Return_code}
    Sleep       1s
...
Edit Authorization Profiles
    ...
    ...     ELSE IF     '${New_Default_authorization}' == 'reject'        Run Keywords      Click Element    ${Default_Reject_Field}  
    ...    AND   Input Text      id=default    ${Return_code}
...
Add Routing Profiles
    [Arguments]   ${Index}  ${Default_routing}	 ${less_more_method1}  ${Method_name1}   ${Forward_address1}      ${less_more_method2}     ${Method_name2}   ${Forward_address2}
    ...
    Add_Edit Routing Profiles   ${Default_routing}	${less_more_method1}   ${Method_name1}   ${Forward_address1}      ${less_more_method2}     ${Method_name2}   ${Forward_address2}

Edit Routing Profiles
    [Arguments]   ${Index}  ${Default_routing}	 ${New_Default_routing}   ${less_more_method1}    ${Method_name1}   ${Forward_address1}      ${less_more_method2}     ${Method_name2}   ${Forward_address2}
    ...
    Add_Edit Routing Profiles   ${New_Default_routing}	  ${less_more_method1}   ${Method_name1}   ${Forward_address1}      ${less_more_method2}     ${Method_name2}   ${Forward_address2}

Add_Edit Routing Profiles
    [Arguments]   ${Default_routing}	${less_more_method1}   ${Method_name1}   ${Forward_address1}      ${less_more_method2}     ${Method_name2}   ${Forward_address2}


    #Add more method
    IF   '${less_more_method1}' == 'add'                     Click Element         ${Add_Method_Button}
    #Remove method
    ...   ELSE IF  '${less_more_method1}' == 'remove'                    Click Element         ${Remove_Method_Button1}
    Sleep       1s
    ...
    #Add more method
    IF   '${less_more_method2}' == 'add'                     Click Element         ${Add_Method_Button}
    #Remove method
    ...   ELSE IF  '${less_more_method2}' == 'remove'                    Click Element         ${Remove_Method_Button2}
    Sleep       1s
...
Edit Valid SDP Profile
    ...
    # Sleep       2s
     ...
     ${arg} =  Create List  ${Index}    ${Xpath_Default_behavior_Edit_Button}
    Run Keyword N Times And Stop If Success   Click Edit Element With 2 Info   ${arg}    Click Element   ${Next_page}   3
    Sleep   3s
...
Add_Edit SDP Profile
    ...
    Run Keyword If  '${Applicability}' != '#BLANK'           Run Keywords     Click Element        ${Applicability_Dropdown_List}  AND  Sleep  2.5s   AND  Page Should Not Contain Element    ${Applicability_None}
    Sleep       2s
    ...
    Run Keyword If   '${less_more_SDP_rule}' != 'cancel'          Click Element       ${Confirm_Add_Type_Button}
    Sleep       3s
...
View SDP Profile
    ...
    # Sleep       3s
     ...
     ${arg} =  Create List   ${Index}    ${Xpath_Media_type__View_Button}
    Run Keyword N Times And Stop If Success   Click View Element With 2 Info   ${arg}    Click Element   ${Next_page}   6
    Sleep   3s
...
Add PeerIBCF
	...
	...  ${word_processing}		${Precondition_entry}		${Precondition_exit}   ${CdrPaniSource}
    ...
    Add_Edit PeerIBCF   ${Authorization}    ${Domain}    ${Less_more_domain}   ${Domain1}     ${Max_both}	  ${PBX}  	${Trusted}    ${Privacy}	  ${Filtering}
	...  ${RTCP}	  ${Hiding}   ${Behavior}   ${1st_protocol}	  ${2nd_protocol}   ${TPIP_extern}   ${SDP_profile}    ${Rfc4028}	${Interworking}		${Prack}	${Session_control}
	...  ${Session_limiter}    ${ASHM}      ${ASHM1}     ${ASHM2}     ${ASHM3}   ${Check_source}	${Silent}	${Home_domain}	  ${Not_ChangePAI}	 ${Extern_domain}	${Forwarder_mode}	${Forwarder_domain}
    ...
    Sleep       1s
    #24552 FFT - LBO : reporting PANI in CDR according interco mode - CLI command
    Run Keyword If   '${CdrPaniSource}' != '#BLANK'          Click Element      ${CdrPaniSource_dropdown}
    Sleep       2s

    Run Keyword If       '${CdrPaniSource}' == 'FFT'           Click Element      ${CdrPaniSource_FFT}
    ...         ELSE IF  '${CdrPaniSource}' == 'LBO'           Click Element      ${CdrPaniSource_LBO}
    ...         ELSE IF  '${CdrPaniSource}' == 'NONE'           Click Element     ${CdrPaniSource_NONE}
    Sleep       1s
...
Edit PeerIBCF
	...
	...  ${Lac_stripping}   ${User2Net}  ${Net2User}   ${Precondition_entry}  ${Precondition_exit}  ${CdrPaniSource}
    ...
    PeerIBCF Edit FT   ${Authorization}    ${New_Domain}    ${Less_more_domain}     ${Domain1}   ${Max_both}	  ${PBX}  	${Trusted}   ${Privacy}	  ${Filtering}
	...  ${RTCP}	  ${Hiding}   ${Behavior}   ${1st_protocol}	  ${2nd_protocol}   ${TPIP_extern}   ${SDP_profile}    ${Rfc4028}	${Interworking}		${Prack}	${Session_control}
	...  ${Session_limiter}    ${ASHM}      ${ASHM1}     ${ASHM2}     ${ASHM3}   ${Check_source}	${Silent}	${Home_domain}	  ${Not_ChangePAI}	 ${Extern_domain}	${Forwarder_mode}	${Forwarder_domain}
	...  ${Media_profile}	${1st_SRTP}		${2nd_SRTP}		${Maskv6}	${Reveal}	${Add_KA}  	${KA_TPIP1}      ${1st_Period1}	${2nd_Period1}
	...  ${Max_forward1}   ${Precondition_entry}  ${Precondition_exit}  ${CdrPaniSource}
...
Add_Edit PeerIBCF
    ...
    Run Keyword If     '${Authorization}' == '1'      Click Element                               ${Autho_index_1}
    ...       ELSE IF  '${Authorization}' == '3'      Click Element                               ${Autho_index_3}
    ...       ELSE IF  '${Authorization}' == '5'      Click Element                               ${Autho_index_5}
    ...       ELSE IF  '${Authorization}' == '6'      Click Element                               ${Autho_index_6}
    ...
    ...      ELSE IF   '${Rfc4028}' == '18'         Click Element     ${RFC4028_18}
    Sleep       2s
    ...
    Run Keyword If      '${Session_limiter}' != '#BLANK'        Click Element     ${Session_limiter_dropdown}
    Sleep       1s
...
PeerIBCF Edit FT
    [Arguments]    ${Authorization}    ${New_Domain}    ${Less_more_domain}   ${Domain1}     ${Max_both}	  ${PBX}  	${Trusted}    ${Privacy}	  ${Filtering}
	...  ${RTCP}	  ${Hiding}   ${Behavior}   ${1st_protocol}	  ${2nd_protocol}   ${TPIP_extern}   ${SDP_profile}    ${Rfc4028}	${Interworking}		${Prack}	${Session_control}
	...  ${Session_limiter}    ${ASHM}      ${ASHM1}     ${ASHM2}     ${ASHM3}   ${Check_source}	${Silent}	${Home_domain}	  ${Not_ChangePAI}	 ${Extern_domain}	${Forwarder_mode}	${Forwarder_domain}
	...  ${Media_profile}	${1st_SRTP}		${2nd_SRTP}		${Maskv6}	${Reveal}	${Add_KA}  	${KA_TPIP1}      ${1st_Period1}	${2nd_Period1}
	...  ${Max_forward1}   ${Precondition_entry}  ${Precondition_exit}  ${CdrPaniSource}    #${less_more_Global_KA}   ${KA_TPIP2}  ${1st_Period2}	${2nd_Period2}	${Max_forward2}
    ...
    Run Keyword If  '${New_Domain}' != '#BLANK'                 Input Text       ${Multi_Domain_Field}              ${New_Domain}
    Sleep       1s
...
View PeerIBCF
    [Arguments]    ${Name}  ${Max_in}	${Max_out}	 ${Routing}	   ${Authorization}   ${Domain}   ${Precondition_entry}   ${Precondition_exit}  ${RFC_4028}  ${CdrPaniSource}
    ...
    #24552 verify CdrPaniSource default FFT
    Verify Page Contains 2 Expected Elements    CdrPaniSource                                   ${CdrPaniSource}
    Run Keyword If    '${RFC_4028}' != '#BLANK'                Verify Page Contains 2 Expected Elements    rfc4028 Profile           ${RFC_4028}
    ...
    Run Keyword If    '${CdrPaniSource}' != '#BLANK'       Verify Page Contains 2 Expected Elements    CdrPaniSource             ${CdrPaniSource}
