...
Filter Registered User function
    [Arguments]  ${Public_identity}
    Reload Page
    Click Element        ${Filter_Button}
    Sleep       3s
    Filter value       ${Filter_First_Value}    ${Public_identity}
    Verify Page Contains 1 Expected Elements    ${Public_identity}
...
Filter Special Character Registered User function
    ...
    Sleep       3s
    Filter value       ${Filter_First_Value}        ${Public_identity}
    Verify Page Not Contains 1 Expected Elements    ${Public_identity}
    Click Element  ${Cancel_Filter}
    Sleep       2s