...
# ${IP_Dropdown_PCSCF}          xpath=(//div[text()[normalize-space() = 'IP:']]//following::input[@class='select-dropdown'])[1]
${IP_Dropdown_PCSCF}          xpath=//input[@value='${ifcfg-lo}']
# ${IP_Dropdown_PCSCF}          xpath=//input[@value='${eth0}']
...
Add TPIP
    ...
    # Run Keyword If  '${Type}' == 'network' and '${IP_Version}' != 'ETH'     Click Element       ${IP_Dropdown_PCSCF}
    # Sleep       1s
    Run Keyword If    '${TPIP_IP_DROPDOWN}' == '${eth0}' and '${Type}' == 'network' and '${IP_Version}' != 'ETH'      Click Element        ${TPIP_IP_DropDown_eth0} 
    ...    ELSE IF    '${TPIP_IP_DROPDOWN}' == '${ifcfg-lo}' and '${Type}' == 'network' and '${IP_Version}' != 'ETH'      Click Element        ${TPIP_IP_DropDown_127}
    Sleep       1s       
    ...
    Run Keyword If  '${Type}' != 'network' and '${IP_Version}' =='IPV4' and '${IP}' != '#BLANK'   Run Keywords     Click Element        xpath=//button[@value='IP v4'] 
    ...  AND  Click Element        xpath=//label[@for='ip']/following-sibling::div[2]/input  AND  Sleep       2s 
    ...  AND   Click Element    xpath=//span[text()='${HOST_SBC}'] 
    Sleep       3s

    Run Keyword If  '${Type}' != 'network' and '${IP_Version}' =='IPV4' and '${IP}' == '#BLANK'   Run Keywords     Click Element        xpath=//button[@value='IP v4']  
    ...  AND  Click Element        xpath=//label[@for='ip']/following-sibling::div[2]/input  AND  Sleep       1s  
    ...  AND   Click Element     xpath=//label[@for='ip']/following-sibling::div[2]//span[contains(.,'127.0.0.1')]
    Sleep       3s

    Run Keyword If  '${Type}' != 'network' and '${IP_Version}' =='IPV6' and '${IP}' != '#BLANK'   Run Keywords     Click Element        xpath=//button[@value='IP v6']  
    ...  AND  Click Element        xpath=//label[@for='ip']/following-sibling::div[2]/input  AND  Sleep       1s  
    ...  AND   Click Element    xpath=//label[@for='ip']/following-sibling::div[2]/ul/li[1]
    Sleep       3s
    
    Run Keyword If  '${Type}' != 'network' and '${IP_Version}' =='IPV6' and '${IP}' == '#BLANK'   Run Keywords     Click Element        xpath=//button[@value='IP v6'] 
    ...  AND  Click Element        xpath=//label[@for='ip']/following-sibling::div[2]/input  AND  Sleep       1s  
    ...  AND   Click Element    xpath=//label[@for='ip']/following-sibling::div[2]/ul/li[2]
    Sleep       3s
