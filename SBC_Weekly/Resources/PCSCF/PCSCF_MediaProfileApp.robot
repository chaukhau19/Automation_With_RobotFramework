...
Add Media Profile function
    [Arguments]  ${Info}
    PCSCF_MediaProfilePage.Add MediaProfile  ${Info[4]}  ${Info[5]}   ${Info[6]}    ${Info[7]}    ${Info[8]}  ${Info[9]}   ${Info[10]}   ${Info[11]}    
...
Edit Media Profile function
    [Arguments]  ${Info}
    PCSCF_MediaProfilePage.Edit MediaProfile  ${Info[4]}  ${Info[16]}   ${Info[17]}    ${Info[18]}    ${Info[19]}  ${Info[20]}   ${Info[21]}   ${Info[22]}  
...
View Media Profile function
    [Arguments]  ${Info}
    PCSCF_MediaProfilePage.View MediaProfile  ${Info[4]}  ${Info[5]}   ${Info[6]}   ${Info[7]}  ${Info[8]}   ${Info[9]}   ${Info[10]}   ${Info[11]}     ${Info[12]}  
    ...    ${Info[13]}   ${Info[14]}
    Back from View Page
