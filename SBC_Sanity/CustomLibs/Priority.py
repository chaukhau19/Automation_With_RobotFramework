...
def get_priority_colums(filename, sheetname):
    ...
    for column in range(1, number_of_columns):
        ...
        if (checking_column != 'LOW'and checking_column != 'MEDIUM' and checking_column != 'HIGH' and checking_column != 'CRITICAL'):
...
#read_excel_file('D:\\HANHAN\\CIRPACK\\Cirpack\\Testing\\RobotFramework\\IMS_WEB\\IMS_WEB\\Data\\WebProv\\HSS_Profile\\Authorized_Network.xlsx', 'Add', 'CRITICAL')