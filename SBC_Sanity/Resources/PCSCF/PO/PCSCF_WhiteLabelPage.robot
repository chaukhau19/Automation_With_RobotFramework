...
${Whitelabel_section64}             xpath=//a[contains(text(),'White label')]
${Sub_Whitelabel_section}           xpath=//a[@class='sub-menu'][contains(text(),'White label')]
${Edit_Button}                      xpath=//div[@class='footer-button']//a[1]
${Reset_Button}                      xpath=//div[@class='footer-button']//a[2]
...
Go to Whitelabel section in PCSCF tab 64

    Click Element        ${Whitelabel_section64}
     Sleep  1s
