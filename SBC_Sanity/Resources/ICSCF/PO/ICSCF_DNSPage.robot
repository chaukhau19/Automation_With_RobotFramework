...
*** Variables ***
############ General variables ##############
${DNS_tab}                  xpath=//a[@class='collapsible-header active'][contains(.,'Icscf')]//following::*[@class='collapsible-header first-menu' and contains(text(),'DNS')]
${Configuration_tab}        xpath=//a[@class='collapsible-header active'][contains(.,'Icscf')]//following::*[@class='collapsible-header sub-menu' and contains(text(),'Configuration')]
${Configuration_section}    xpath=//a[@href='/icscf/1/dns/index']
${Resolver_section}         xpath=//a[@href='/icscf/1/resolv/index']
