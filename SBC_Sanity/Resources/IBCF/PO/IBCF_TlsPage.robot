...
*** Variables ***
${TLS_section}      xpath=//*[@class='collapsible-header active' and contains(text(),'Ibcf')]/following::div//a[@class='first-menu' and contains(text(),'Tls')]
*** Keywords ***
Go to IBCF tab
...
Add_Edit TLS
    ...
    #Run Keyword If  '${CA}' != '#BLANK'                                 choose file       id=cafile     D:\\Cirpack\\Automation\\SVN\\WEB_SBC_RF\\Data\\IBCF\\CA.txt
    Sleep  1s
