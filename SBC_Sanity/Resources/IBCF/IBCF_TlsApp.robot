...
Add TLS function
    [Arguments]  ${Info}
    IBCF_TlsPage.Add TLS  ${Info[4]}  ${Info[5]}   ${Info[6]}    ${Info[7]}    ${Info[8]}  ${Info[9]}  ${Info[10]}   ${Info[11]}     ${Info[12]}   ${Info[13]}   ${Info[14]}  ${Info[15]}  ${Info[16]}   ${Info[17]}   ${Info[18]}
    reload page
...
Verify errors in edit TLS rules function
    [Arguments]  ${Info}
    IBCF_TlsPage.Edit TLS  ${Info[4]}  ${Info[5]}   ${Info[6]}    ${Info[7]}    ${Info[8]}  ${Info[9]}   ${Info[10]}   ${Info[11]}     ${Info[12]}   ${Info[13]}   ${Info[14]}  ${Info[15]}
