...
${Time_out}             20
${BGCF_section}              xpath=//a[@class='collapsible-header active'][contains(.,'Scscf')]//following::a[@class='first-menu'][contains(text(),'Bgcf')]
################# Add Page ##################
...
Add_BGCF_All
    ...
    Run Keyword If  '${Weight}' != '#BLANK'    input text   ${SCSCF_Weight_Field}          ${Weight}
    Sleep       1s
...
Edit BGCF
    ...
    Run Keyword If  '${Edit_Weight}' != '#BLANK'    input text   ${SCSCF_Weight_Field}          ${Edit_Weight}
    Sleep       1s
