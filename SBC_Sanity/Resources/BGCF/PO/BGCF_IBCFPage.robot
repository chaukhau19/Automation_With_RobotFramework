...
View IBCF
    ...
    Common.Click View Element With 3 Info      ${IP}       ${Port}      ${Weight}
    Sleep  5s
    Common.Verify Page Contains 3 Expected Info   ${IP}  ${Port}  ${Weight}
...
Edit IBCF
    [Arguments]    ${IP}     ${Port}    ${Weight}     ${Edit_Weight}      ${Edit_Domain}
    Common.Click Edit Element With 3 Info      ${IP}       ${Port}      ${Weight}
    Sleep  5s
